...
export default function SettingsPage() {
    ...
    if (dbSettings) {
      ...
      if (dbSettings) {
        form.reset({
          ...
          currencyDecimal: dbSettings.currencyDecimal ?? 2,
  ...
  const form = useForm<SettingsFormData>({
    ...
    defaultValues: {
      ...
      kdShowTableNumber: settings.kdShowTableNumber !== false,
      kdShowOrderTime: settings.kdShowOrderTime !== false,
      kdShowClock: settings.kdShowClock !== false,
      kdShowNotes: settings.kdShowNotes !== false,
      kdHasPendingStatus: settings.kdHasPendingStatus !== false,
      kdShowRecentlyCompleted: settings.kdShowRecentlyCompleted !== false,
      kdPendingColor: settings.kdPendingColor || '#FF9800',
      kdPreparingColor: settings.kdPreparingColor || '#2196F3',
      kdReadyColor: settings.kdReadyColor || '#4CAF50',
      restaurantInstagram,
      restaurantWhatsapp,
      restaurantTelegram,
  ...
  const handleSubmit = (data: SettingsFormData) => {
    ...
    const updatedSettings = {
      ...
      restaurantInstagram: data.restaurantInstagram || restaurantInstagram,
