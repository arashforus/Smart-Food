...
export const items = pgTable("items", {
  ...
  generalName: text("general_name").notNull().default(""),
  name: jsonb("name").notNull().$type<Record<string, string>>(),
  shortDescription: jsonb("short_description").notNull().$type<Record<string, string>>(),
  longDescription: jsonb("long_description").notNull().$type<Record<string, string>>(),
  ...
  smokeEffect: boolean("smoke_effect").notNull().default(false),
  fireEffect: boolean("fire_effect").notNull().default(false),
...
export const settings = pgTable("settings", {
  ...
  menuShowOperationHours: boolean("menu_show_operation_hours").notNull().default(true),
  menuShowMenu: boolean("menu_show_menu").notNull().default(true),
  menuShowAllMenuItems: boolean("menu_show_all_menu_items").notNull().default(true),
  menuShowRecommendedMenuItems: boolean("menu_show_recommended_menu_items").notNull().default(true),
  menuShowFoodType: boolean("menu_show_food_type").notNull().default(true),
  menuShowSearchBar: boolean("menu_show_search_bar").notNull().default(true),
  menuShowViewSwitcher: boolean("menu_show_view_switcher").notNull().default(true),
  menuShowPrices: boolean("menu_show_prices").notNull().default(true),
  menuShowImages: boolean("menu_show_images").notNull().default(true),
  menuShowIngredients: boolean("menu_show_ingredients").notNull().default(true),
